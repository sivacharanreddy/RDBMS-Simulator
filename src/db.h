...
/* This table row definition is for inserting records into a table file */
typedef struct tabfile_row_def
{
...
typedef enum error_return_codes
{
  ...
  INCORRECT_DATA_TYPE,               // -387
  NULL_IS_ASSIGNED,                 // -386
  WRONG_VALUE_LENGTH,                // -385
  INVALID_AGG_FUNCT_PARAM,           // -384
  INVALID_RELATIONAL_OPERATOR,       // -383  
   /* Must add all the possible errors from I/U/D + SELECT here */
	FILE_OPEN_ERROR = -299,			// -299
	DBFILE_CORRUPTION,					// -298
	MEMORY_ERROR,							  // -297
	TABLEFILE_CORRUPTION,					//-296
	BACKUPFILE_ALREADY_EXISTS             // -295
